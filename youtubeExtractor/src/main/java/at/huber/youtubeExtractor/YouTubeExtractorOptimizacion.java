...
public abstract class YouTubeExtractorOptimizacion extends AsyncTask<String, Void, SparseArray<YtFile>> {

    private final static boolean CACHING = true;

    static boolean LOGGING = false;

    private final static String LOG_TAG = "YouTubeExtractorOptimizacion";
...
*/
    ...
    public YouTubeExtractorOptimizacion(@NonNull Context con) {
